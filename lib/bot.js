...
const authorizedChats = [process.env.AUTHORIZED_CHATS];
var lastUrl = '';
...
function bot(torrent, bot) {
  ...
  bot.on("message", async msg => {
    if(authorizedChats.includes(msg.chat.id)){
      if (!msg.document) return bot.sendMessage(msg.chat.id, "You are Requesting Heaven in Unethical Manner 😜. Try \"/help download\" for  help.");
